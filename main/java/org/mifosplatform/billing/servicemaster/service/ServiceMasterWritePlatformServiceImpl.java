...
import org.mifosplatform.portfolio.billing.domain.ServiceMasterRepository;
...
@Autowired
 public ServiceMasterWritePlatformServiceImpl(final PlatformSecurityContext context,
		 final ServiceMasterRepository serviceMasterRepository,final ServiceCommandFromApiJsonDeserializer fromApiJsonDeserializer)
{
