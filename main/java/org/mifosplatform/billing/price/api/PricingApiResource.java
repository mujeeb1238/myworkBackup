...
public class PricingApiResource {
    ...
    private final String resourceNameForPermissions = "PRICE";
	  private final PlatformSecurityContext context;
	    ...
	    @Autowired
	    public PricingApiResource(final PlatformSecurityContext context, 
	...
	@Consumes({ MediaType.APPLICATION_JSON })
	@Produces({ MediaType.APPLICATION_JSON })
	public String retrievePricing(@QueryParam("plan_code") final Long planCode,@Context final UriInfo uriInfo) {
		...
		PricingData data = new PricingData(serviceData, chargeDatas, datas,	discountdata, serviceData.get(0).getCode(), planCode,null);
