...
public class UploadStatusApiResource {
    ...
    //ApiRequestJsonSerializationSettings settings
	 ...
	 @Path("/getData")
	    ...
	    public String retrieveCode( @Context final UriInfo uriInfo) {
	...
	@Consumes({ MediaType.APPLICATION_JSON })
	@Produces({ MediaType.APPLICATION_JSON })
	public Response updateOrder(@PathParam("uploadStatusId") final Long uploadStatusId, @Context final UriInfo uriInfo) {
