...
public class InventoryItemDetails extends AbstractAuditableCustom<AppUser, Long>{
	...
	public static InventoryItemDetails fromJson(JsonCommand command, FromJsonHelper fromJsonHelper){
		...
		Integer w = command.integerValueSansLocaleOfParameterNamed("warranty");
		...
		return new InventoryItemDetails(itemMasterId,serialNumber,grnId,provisioningSerialNumber,quality,status,warranty,remarks);
	}
