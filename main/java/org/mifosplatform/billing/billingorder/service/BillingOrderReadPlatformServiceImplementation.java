...
public DiscountMasterData mapRow(ResultSet rs, int rowNum)
	...
	return new DiscountMasterData(discountMasterid, orderPriceId,
			discountMasterId, discountStartDate, discountEndDate,
			discountType, discountRate, isDeleted);
}
