	 ...
	 //for post method
	    ...
	    public CommandProcessingResult addMessageTemplate(JsonCommand command) {
			...
			try {
	            ...
	            final JsonArray billingMessageparamArray=command.arrayOfParameterNamed("messageParameters").getAsJsonArray();
				  ...
				  Long number=new Long(1);
					 ...
					 final String parameterName = fromApiJsonHelper.extractStringNamed("param", element);
