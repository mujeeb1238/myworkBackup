...

{
	...
	public List<PlanCodeData> retrieveAllPlatformData() {
		  context.authenticatedUser();
	        ...
	        String sql = "select s.id as id,s.plan_code as plan_code from b_plan_master s where s.plan_status=1 and  s.is_deleted='n'  ";
	...
	public List<OrderData> retrieveOrderLineData(Long orderId) {
		 ...
		 context.authenticatedUser();
	        ...
	        String sql = "select o.id as id,o.order_id as order_id,o.service_id as service_id,o.service_type as service_type,"
				+"o.service_status as service_status from b_order_line o where o.order_id= ?";
...
return null;
	...
	public List<PaytermData> getChargeCodes(Long planCode) {
		 ...
		 context.authenticatedUser();
	        ...
	        String sql = "Select DISTINCT b.billfrequency_code as billfrequency_code,b.id as id from b_plan_pricing a,b_charge_codes b where a.charge_code=b.charge_code and " +
				" a.is_deleted='n' and plan_id=?";
	...
	public List<org.mifosplatform.billing.order.data.OrderData> retrieveClientOrderDetails(
		...
		try {
			...
			return "o.id AS id, o.plan_id AS plan_id, o.start_date AS start_date,o.order_status AS order_status,p.plan_code AS plan_code,"
					+"o.end_date AS end_date,co.contract_period as contractPeriod ,  (SELECT sum(ol.price) AS price FROM b_order_price ol"
